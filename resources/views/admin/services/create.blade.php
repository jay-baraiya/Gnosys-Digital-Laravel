...
@section('page-title', 'Add New Digital Service')
            ...
            <div class="card-body">
                <form action="{{ route('admin.services.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="visibility" id="visibility_public" value="1" checked>
                                    <label class="form-check-label" for="visibility_public">Public</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="visibility" id="visibility_private" value="0">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="tags[]" class="form-control mb-2" placeholder="Add tag and press enter">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card mb-3 border">
                                ...
                                <div class="card-body">
                                    <div id="gallery-container" class="row g-2"></div>
                                ...
                                <div class="tab-content flex-grow-1 p-4" id="v-pills-tabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="v-pills-general" role="tabpanel">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="product_data[general][regular_price]" class="form-control">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label class="col-sm-3 col-form-label">Sale price ($)</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="product_data[general][sale_price]" class="form-control">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                    ...
                                    <div class="tab-pane fade" id="v-pills-inventory" role="tabpanel">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-6 d-flex align-items-center">
                                                <input type="checkbox" name="product_data[inventory][manage_stock]" value="1" class="form-check-input mt-0">
                                    ...
                                    <div class="tab-pane fade" id="v-pills-shipping" role="tabpanel">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="product_data[shipping][weight]" class="form-control" placeholder="0">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="row g-2">
                                                    <div class="col">
                                                        <input type="text" name="product_data[shipping][length]" class="form-control" placeholder="Length">
                                                    </div>
                                                    <div class="col">
                                                        <input type="text" name="product_data[shipping][width]" class="form-control" placeholder="Width">
                                                    </div>
                                                    <div class="col">
                                                        <input type="text" name="product_data[shipping][height]" class="form-control" placeholder="Height">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="v-pills-linked" role="tabpanel">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="product_data[linked][upsells]" class="form-control" placeholder="Search for a product...">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label class="col-sm-3 col-form-label">Cross-sells</label>
                                            <div class="col-sm-9">
                                                <input type="text" name="product_data[linked][cross_sells]" class="form-control" placeholder="Search for a product...">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="v-pills-advanced" role="tabpanel">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea name="product_data[advanced][purchase_note]" class="form-control" rows="2"></textarea>
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-6 d-flex align-items-center">
                                                <input type="checkbox" name="product_data[advanced][enable_reviews]" value="1" checked class="form-check-input mt-0">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row border-top mt-4 pt-4">
                        <div class="col-12">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control @error('detailed_description') is-invalid @enderror" id="detailed_description" name="detailed_description" rows="10">{{ old('detailed_description') }}</textarea>
                            </div>
                    ...
                    <div class="d-flex justify-content-between mt-4 border-top pt-4">
                        ...
                        <button type="submit" class="btn btn-primary px-5">Publish Digital Service</button>
                    </div>
                </form>
            </div>
        </div>
