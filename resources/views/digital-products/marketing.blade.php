    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 mx-auto text-center">
                <h1 class="products-hero-title" data-aos="fade-up">Marketing Kits</h1>
                <p class="products-hero-subtitle" data-aos="fade-up" data-aos-delay="100">Complete marketing kits with templates, strategies, and tools for business growth</p>
            </div>
        </div>
    </div>
</section>
